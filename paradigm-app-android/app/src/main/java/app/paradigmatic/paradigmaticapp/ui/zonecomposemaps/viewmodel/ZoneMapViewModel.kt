package app.paradigmatic.paradigmaticapp.ui.zonecomposemaps.viewmodel
...
import app.paradigmatic.paradigmaticapp.ui.zonecomposemaps.clusters.calculateCameraViewPoints
import app.paradigmatic.paradigmaticapp.ui.zonecomposemaps.clusters.getCenterOfPolygon
...
@HiltViewModel
class ZoneMapViewModel @Inject constructor(): ViewModel() {

    val state: MutableState<ZoneMapState> = mutableStateOf(
        ZoneMapState(
